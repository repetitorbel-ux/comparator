...
GUI показывает side-by-side diff для выбранной пары файлов и разрешает редактирование текстовых файлов (с сохранением исходной кодировки файла).

## Основные возможности

- настольный GUI на PySide6;
- side-by-side diff для выбранной пары файлов;
- `Edit Mode` для выбранной пары файлов (включая строки, где файл есть только с одной стороны);
